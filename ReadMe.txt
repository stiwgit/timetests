========================================================================
    KONSOLENANWENDUNG: timetests-Projektübersicht
========================================================================

Diese timetests-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die timetests-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen timetests.pch sowie eine vorkompilierte 
